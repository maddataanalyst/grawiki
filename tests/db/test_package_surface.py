...
def test_missing_falkordb_extras_raise_clear_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(ModuleNotFoundError, match="grawiki\\[falkordb\\].*grawiki\\[falkordblite\\]"):
